...
ReLocalization::ReLocalization(const std::string& map_path):
    ...
    localization_thread_ptr_ = std::make_unique<std::thread>(&ReLocalization::Run, this);
    map_origin_ptr_ = std::make_unique<pcl::PointCloud<pcl::PointXYZINormal>>();
    map_cloud_ptr_ = std::make_unique<pcl::PointCloud<pcl::PointXYZINormal>>();
